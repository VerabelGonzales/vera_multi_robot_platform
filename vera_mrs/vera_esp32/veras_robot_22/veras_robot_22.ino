...
// ROS /cmd_vel
ros::Subscriber<geometry_msgs::Twist> sub("robot_2/cmd_vel", &cmd_velCallback);

// ROS topic de los Tiks de los encoder de los motores: 1, 2, 3, 4
std_msgs::Int16MultiArray wheels_desired_rate_msg;
ros::Publisher wheels_desired_rate_pub("robot_2/wheel_ticks", &wheels_desired_rate_msg);
...
ros::Publisher ir_distances_pub("robot_2/ir_distances", &ir_distances_msg);
