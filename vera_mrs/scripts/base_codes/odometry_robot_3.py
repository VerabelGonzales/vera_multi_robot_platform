...
class OmniTf:
    ...
    def __init__(self):
        rospy.init_node("wheel_odometry_robot_3")
        ...
        rospy.Subscriber("robot_3/wheel_ticks", Int16MultiArray, self.ticksCallback)

        self.odomPub = rospy.Publisher("robot_3/odom", Odometry, queue_size=10)
