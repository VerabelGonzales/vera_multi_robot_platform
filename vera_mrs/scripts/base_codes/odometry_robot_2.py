...
class OmniTf:
    ...
    def __init__(self):
        rospy.init_node("wheel_odometry_robot_2")
        ...
        rospy.Subscriber("robot_2/wheel_ticks", Int16MultiArray, self.ticksCallback)

        self.odomPub = rospy.Publisher("robot_2/odom", Odometry, queue_size=10)
