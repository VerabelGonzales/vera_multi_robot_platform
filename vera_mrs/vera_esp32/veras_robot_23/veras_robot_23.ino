...
Motor motor1(5, 18, 19, 0);
Motor motor4(17, 16, 4, 3);
Motor motor2(32, 26, 27, 1);
Motor motor3(25, 33, 23, 2);

// Asignacion de los pines a los encoders 
Encoder encoder1(21, 22);
Encoder encoder3(12, 14);
Encoder encoder2(13, 15);
Encoder encoder4(2, 0);
...
const float RPM_CONVERSION_FACTOR = 60.0 / 2054;
...
// ROS /cmd_vel
ros::Subscriber<geometry_msgs::Twist> sub("robot_3/cmd_vel", &cmd_velCallback);

// ROS topic de los Tiks de los encoder de los motores: 1, 2, 3, 4
std_msgs::Int16MultiArray wheels_desired_rate_msg;
ros::Publisher wheels_desired_rate_pub("robot_3/wheel_ticks", &wheels_desired_rate_msg);
...
ros::Publisher ir_distances_pub("robot_3/ir_distances", &ir_distances_msg);
...
void setup()
{
  ...
  PID_M1.SetOutputLimits(20.0 * (255.0/500.0), 500.0 * (255.0/500.0));

  PID_M2.SetMode(AUTOMATIC);
  PID_M2.SetOutputLimits(20.0 * (255.0/500.0), 500.0 * (255.0/500.0));

  PID_M3.SetMode(AUTOMATIC);
  PID_M3.SetOutputLimits(20.0 * (255.0/500.0), 500.0 * (255.0/500.0));

  PID_M4.SetMode(AUTOMATIC);
  PID_M4.SetOutputLimits(20.0 * (255.0/500.0), 500.0 * (255.0/500.0));
