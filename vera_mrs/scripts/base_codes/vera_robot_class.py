...
class VeraRobot:
    ...
    def run_navigation(self):
        ...
        if command == "go":
            ...
            self.goal_to_navigation(1, 0.5, -0.2)
            self.goal_to_navigation(2, 0.5, -0.8)
            self.goal_to_navigation(3, 0.5, -1.4)
        ...
        while not rospy.is_shutdown():
            ...
            if self.check_collision('robot_1', 'robot_2'):
                ...
                print("Posible colicion entre el robot 1 y robot 2")

                if self.euclidean_distance(1) > self.euclidean_distance(2):
                    ...
                    # Crear y enviar un mensaje de cancelación
                    cancel_msg = GoalID()  # Un mensaje vacío de GoalID cancelará la meta actual
                    self.cancel_goal_robot_2.publish(cancel_msg)
                    self.result_data_robot_2.status.status = None
                ...
                print("Posible colicion entre el robot 1 y robot 3")
                
                if self.euclidean_distance(1) > self.euclidean_distance(3):
                    # Crear y enviar un mensaje de cancelación
                    cancel_msg = GoalID()  # Un mensaje vacío de GoalID cancelará la meta actual
                    self.cancel_goal_robot_1.publish(cancel_msg)
                    self.result_data_robot_1.status.status = None
                    ...
                    # Crear y enviar un mensaje de cancelación
                    cancel_msg = GoalID()  # Un mensaje vacío de GoalID cancelará la meta actual
                    self.cancel_goal_robot_3.publish(cancel_msg)
                    self.result_data_robot_3.status.status = None
            ...
            elif self.check_collision('robot_2', 'robot_3'):

                print("Posible colicion entre el robot 2 y robot 3")

                if self.euclidean_distance(2) > self.euclidean_distance(3):
                    # Crear y enviar un mensaje de cancelación
                    cancel_msg = GoalID()  # Un mensaje vacío de GoalID cancelará la meta actual
                    self.cancel_goal_robot_2.publish(cancel_msg)
                    self.result_data_robot_2.status.status = None
            ...
            elif self.check_collision('robot_3', 'robot_2'):

                print("Posible colicion entre el robot 3 y robot 2")

                if self.euclidean_distance(3) > self.euclidean_distance(2):
                    # Crear y enviar un mensaje de cancelación
                    cancel_msg = GoalID()  # Un mensaje vacío de GoalID cancelará la meta actual
                    self.cancel_goal_robot_3.publish(cancel_msg)
                    self.result_data_robot_3.status.status = None
