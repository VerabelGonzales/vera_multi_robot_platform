...
class VeraRobot:
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            goal_pose_robot_1.x = self.pose_robot_3.x + L2
            goal_pose_robot_1.y = self.pose_robot_3.y + L 
            goal_pose_robot_1.theta = self.pose_robot_3.theta

            goal_pose_robot_2 = Pose2D()
            goal_pose_robot_2.x = self.pose_robot_3.x -L2
            goal_pose_robot_2.y = self.pose_robot_3.y - L
